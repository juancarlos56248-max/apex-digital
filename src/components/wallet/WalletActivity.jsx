...
export default function WalletActivity({ activeTab, setActiveTab }) {
  return <div>
    <div className="grid grid-cols-2 rounded-lg border border-chart-3/20 bg-secondary/40 p-1">
    ...
    <AnimatePresence mode="wait">
      {activeTab === "inicio" ? <motion.div key="inicio" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="mt-4 rounded-lg border border-chart-3/25 bg-card p-5">
