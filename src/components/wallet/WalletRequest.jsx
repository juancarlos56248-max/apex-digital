...
export default function WalletRequest({ requested, form, setForm, submitting, onSubmit }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-lg border border-success/25 bg-card p-5 md:p-6">
      <div className="absolute right-0 top-0 h-24 w-24 bg-chart-3/10 blur-3xl" />
      <div className="relative">
        <p className="text-[9px] font-bold uppercase tracking-[0.25em] text-success">Card issuance terminal</p>
