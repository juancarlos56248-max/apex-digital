...
export default function LockedWallet({ user, totalInvested, minimum }) {
  ...
  return <div className="mx-auto max-w-md space-y-5">
    ...
    <div className="relative"><div className="pointer-events-none opacity-40 blur-sm"><CyberCard user={user} balance={0} hideBalance onToggleBalance={() => {}} /></div><div className="absolute inset-0 flex items-center justify-center"><div className="rounded-2xl border border-gold/30 bg-background/90 px-6 py-4 text-center backdrop-blur-xl"><Lock className="mx-auto h-5 w-5 text-gold" /><p className="mt-2 text-sm font-bold">Desbloquea con $1,000 invertidos</p></div></div></div>
