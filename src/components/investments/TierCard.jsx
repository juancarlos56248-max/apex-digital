...
const tierConfig = {
  ...
  elite: {
    ...
    stockDesc: "Tesla Inc. es el fabricante de vehículos eléctricos más valioso del mundo. Liderada por Elon Musk, combina innovación en energía, autonomía y manufactura, posicionándose como referente del futuro industrial.",
    features: ["Motor de análisis de alta frecuencia", "Seguimiento de acciones Tesla", "Liquidación cada 24 horas"],
  ...
  institutional: {
    ...
    stockDesc: "Alphabet Inc. (Google) es el holding detrás del motor de búsqueda más usado del mundo, YouTube, Google Cloud y DeepMind. Una de las empresas de mayor capitalización bursátil en el Nasdaq.",
    features: ["Acceso a cartera institucional", "Seguimiento de acciones Alphabet", "Liquidación cada 24 horas"],
