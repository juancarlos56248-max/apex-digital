...
<body style="margin:0;padding:0;background:#050505;font-family:'Helvetica Neue',Arial,sans-serif;">
  <div style="max-width:600px;margin:40px auto;background:#0a0a0a;border:1px solid #1a1a1a;border-radius:16px;overflow:hidden;">
    ...
    <div style="padding:36px 32px;">
      <p style="color:#aaa;font-size:14px;line-height:1.8;margin:0 0 8px;">Hola ${data.full_name || "Inversor"},</p>
      ...
      <p style="color:#444;font-size:11px;line-height:1.6;margin:24px 0 0;text-align:center;">
    ...
    return Response.json({ ok: true, sent_to: data.email });
  } catch (error) {
